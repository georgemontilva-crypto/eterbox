 ...
 * 
 * This script connects to your Railway MySQL database and:
 * 1. Creates all necessary tables
 * 2. Inserts the 3 initial plans (Free, Basic, Corporate)
 * 
 * Usage:
 * 1. Install mysql2: npm install mysql2
 * 2. Run: node init-railway-db.js
 */
...
async function initializeDatabase() {
  ...
  try {
    ...
    const [plans] = await connection.query('SELECT id, name, price, yearlyPrice, maxKeys, maxFolders, maxGeneratedKeys FROM plans');
    ...
    console.log('');
    console.log('✅ You can now access your Pricing page at:');
    console.log('   https://eterbox.com/pricing');
    ...
    if (error.code === 'ER_ACCESS_DENIED_ERROR') {
      console.error('💡 Tip: Check your database credentials in the script');
    } else if (error.code === 'ECONNREFUSED') {
      console.error('💡 Tip: Check your database host and port');
    }
