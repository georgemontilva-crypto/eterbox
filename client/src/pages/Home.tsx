...
import { Lock, Shield, Zap, ArrowRight, Check, Globe } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="container py-20 border-t border-border/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-8 rounded-[15px] bg-card border border-border/20 hover:border-accent/50 transition-colors">
            ...
            <h3 className="text-xl font-bold mb-3">{t("home.features.encryption.title")}</h3>
            <p className="text-muted-foreground">{t("home.features.encryption.desc")}</p>
          </div>
          <div className="p-8 rounded-[15px] bg-card border border-border/20 hover:border-accent/50 transition-colors">
            <Zap className="w-12 h-12 text-accent mb-4" />
            <h3 className="text-xl font-bold mb-3">{t("home.features.fast.title")}</h3>
            <p className="text-muted-foreground">{t("home.features.fast.desc")}</p>
          </div>
          <div className="p-8 rounded-[15px] bg-card border border-border/20 hover:border-accent/50 transition-colors">
            <Lock className="w-12 h-12 text-accent mb-4" />
            <h3 className="text-xl font-bold mb-3">{t("home.features.2fa.title")}</h3>
            <p className="text-muted-foreground">{t("home.features.2fa.desc")}</p>
          </div>
        </div>
      </section>
      ...
      {/* Plans Section */}
      <section className="container py-20 border-t border-border/20">
        <h2 className="text-4xl font-bold text-center mb-16">{t("home.plans.title")}</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="p-8 rounded-[15px] border border-border/20 bg-card hover:border-accent/50 transition-all">
            ...
            <div className="space-y-3 mb-8">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm">3 {t("home.plans.credentials")}</span>
              </div>
              <div className="flex items-center gap-3">
                <Check className="w-5 h-5 text-accent" />
                <span className="text-sm">1 {t("home.plans.folder")}</span>
              </div>
              <div className="flex items-center gap-3">
                <Check className="w-5 h-5 text-accent" />
                <span className="text-sm">{t("home.plans.encryption")}</span>
              </div>
            </div>
            <Button className="w-full" variant="outline" onClick={() => window.location.href = getLoginUrl()}>{t("home.plans.getStarted")}</Button>
          </div>
          ...
          <div className="p-8 rounded-[15px] border-accent bg-accent/5 scale-105 border">
            ...
            <div className="space-y-3 mb-8">
              <div className="flex items-center gap-3">
                <Check className="w-5 h-5 text-accent" />
                <span className="text-sm">25 {t("home.plans.credentials")}</span>
              </div>
              <div className="flex items-center gap-3">
                <Check className="w-5 h-5 text-accent" />
                <span className="text-sm">5 {t("home.plans.folders")}</span>
              </div>
              <div className="flex items-center gap-3">
                <Check className="w-5 h-5 text-accent" />
                <span className="text-sm">{t("home.plans.encryption")}</span>
            ...
            <Button className="w-full" onClick={() => setLocation("/pricing")}>{t("home.plans.subscribeNow")}</Button>
          </div>
          ...
          <div className="p-8 rounded-[15px] border border-border/20 bg-card hover:border-accent/50 transition-all">
            ...
            <div className="space-y-3 mb-8">
              <div className="flex items-center gap-3">
                <Check className="w-5 h-5 text-accent" />
                <span className="text-sm">2500 {t("home.plans.credentials")}</span>
              </div>
              <div className="flex items-center gap-3">
                <Check className="w-5 h-5 text-accent" />
                <span className="text-sm">1500 {t("home.plans.folders")}</span>
              </div>
              <div className="flex items-center gap-3">
                <Check className="w-5 h-5 text-accent" />
                <span className="text-sm">{t("home.plans.encryption")}</span>
            ...
            <Button className="w-full" variant="outline" onClick={() => setLocation("/pricing")}>{t("home.plans.subscribeNow")}</Button>
          </div>
        </div>
      </section>
