  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "bg-background fixed z-50 flex flex-col gap-4 shadow-lg transition-transform duration-[450ms] ease-[cubic-bezier(0.32,0.72,0,1)] pb-[env(safe-area-inset-bottom)]",
          side === "right" &&
