...
export function AppSidebar({ currentPath }: AppSidebarProps) {
  ...
  const menuItems = [
    ...
    { icon: QrCode, label: "QR Codes", path: "/qr-dashboard", color: "text-purple-500" },
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed top-0 left-0 h-full bg-card border-r border-border/20 z-40
        ...
        <div className="p-6 border-b border-border/20">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <h1 className="text-lg font-bold">EterBox</h1>
