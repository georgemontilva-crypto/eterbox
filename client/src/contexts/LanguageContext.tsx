...
export const translations: Translations = {
  ...
  "dashboard.copiedToClipboard": { en: "Copied to clipboard!", es: "¡Copiado al portapapeles!" },
  "dashboard.credentialDeleted": { en: "Credential deleted", es: "Credencial eliminada" },
  "dashboard.failedToDelete": { en: "Failed to delete credential", es: "Error al eliminar credencial" },
  "dashboard.credentialAddedToFolder": { en: "Credential added to folder", es: "Credencial agregada a la carpeta" },
  "dashboard.failedToAdd": { en: "Failed to add credential to folder", es: "Error al agregar credencial a la carpeta" },
  "dashboard.biometricActivated": { en: "Biometric authentication activated successfully!", es: "¡Autenticación biométrica activada exitosamente!" },
  "dashboard.biometricError": { en: "Error activating biometrics", es: "Error al activar biometría" },
  "dashboard.permissionDenied": { en: "Permission denied. Please try again and accept the authentication prompt.", es: "Permiso denegado. Por favor, intenta de nuevo y acepta el prompt de autenticación." },
  "dashboard.credentialExists": { en: "This credential is already registered. Try from another device or delete the existing credential.", es: "Esta credencial ya está registrada. Intenta desde otro dispositivo o elimina la credencial existente." },
  "dashboard.username": { en: "Username:", es: "Usuario:" },
  "dashboard.email": { en: "Email:", es: "Email:" },
  "dashboard.password": { en: "Password:", es: "Contraseña:" },
  "dashboard.notes": { en: "Notes:", es: "Notas:" },
  "dashboard.sharedBy": { en: "Shared by", es: "Compartido por" },
  "dashboard.daysRemaining": { en: "Days remaining", es: "Días restantes" },
  ...
  // QR Codes
  "qr.title": { en: "QR Codes", es: "Códigos QR" },
  "qr.createNew": { en: "Create QR Code", es: "Crear Código QR" },
  "qr.newFolder": { en: "New Folder", es: "Nueva Carpeta" },
  "qr.search": { en: "Search QR codes...", es: "Buscar códigos QR..." },
  "qr.folders": { en: "Folders", es: "Carpetas" },
  "qr.allCodes": { en: "All QR Codes", es: "Todos los Códigos QR" },
  "qr.noCodesYet": { en: "No QR codes yet", es: "No hay códigos QR aún" },
  "qr.noCodesDesc": { en: "Create your first QR code to get started", es: "Crea tu primer código QR para comenzar" },
  "qr.backToAll": { en: "Back to All QR Codes", es: "Volver a Todos los Códigos QR" },
  "qr.view": { en: "View", es: "Ver" },
  "qr.download": { en: "Download", es: "Descargar" },
  "qr.delete": { en: "Delete", es: "Eliminar" },
  "qr.scans": { en: "Scans", es: "Escaneos" },
  "qr.type": { en: "Type", es: "Tipo" },
  "qr.content": { en: "Content", es: "Contenido" },
  "qr.description": { en: "Description", es: "Descripción" },
  "qr.created": { en: "Created", es: "Creado" },
  "qr.close": { en: "Close", es: "Cerrar" },
  
  // Create QR Code Modal
  "qr.create.title": { en: "Create New QR Code", es: "Crear Nuevo Código QR" },
  "qr.create.name": { en: "Name", es: "Nombre" },
  "qr.create.namePlaceholder": { en: "e.g., Website Link, Contact Info", es: "ej., Enlace Web, Info de Contacto" },
  "qr.create.type": { en: "Type", es: "Tipo" },
  "qr.create.typeUrl": { en: "URL / Link", es: "URL / Enlace" },
  "qr.create.typeText": { en: "Plain Text", es: "Texto Plano" },
  "qr.create.typeEmail": { en: "Email", es: "Email" },
  "qr.create.typePhone": { en: "Phone Number", es: "Número de Teléfono" },
  "qr.create.typeWifi": { en: "WiFi", es: "WiFi" },
  "qr.create.typeVcard": { en: "Contact Card", es: "Tarjeta de Contacto" },
  "qr.create.content": { en: "Content", es: "Contenido" },
  "qr.create.contentPlaceholder": { en: "Enter content here", es: "Ingresa el contenido aquí" },
  "qr.create.folder": { en: "Folder (Optional)", es: "Carpeta (Opcional)" },
  "qr.create.noFolder": { en: "No folder", es: "Sin carpeta" },
  "qr.create.description": { en: "Description (Optional)", es: "Descripción (Opcional)" },
  "qr.create.descriptionPlaceholder": { en: "Add any notes...", es: "Agrega notas..." },
  "qr.create.preview": { en: "Preview", es: "Vista Previa" },
  "qr.create.generating": { en: "Generating...", es: "Generando..." },
  "qr.create.enterContent": { en: "Enter content to see preview", es: "Ingresa contenido para ver vista previa" },
  "qr.create.cancel": { en: "Cancel", es: "Cancelar" },
  "qr.create.creating": { en: "Creating...", es: "Creando..." },
  "qr.create.create": { en: "Create QR Code", es: "Crear Código QR" },
  "qr.create.success": { en: "QR code created successfully", es: "Código QR creado exitosamente" },
  "qr.create.error": { en: "Failed to create QR code", es: "Error al crear código QR" },
  
  // Create QR Folder Modal
  "qr.folder.create.title": { en: "Create New Folder", es: "Crear Nueva Carpeta" },
  "qr.folder.create.name": { en: "Folder Name", es: "Nombre de Carpeta" },
  "qr.folder.create.namePlaceholder": { en: "e.g., Business Cards, Events", es: "ej., Tarjetas de Negocio, Eventos" },
  "qr.folder.create.description": { en: "Description (Optional)", es: "Descripción (Opcional)" },
  "qr.folder.create.descriptionPlaceholder": { en: "Add a description...", es: "Agrega una descripción..." },
  "qr.folder.create.cancel": { en: "Cancel", es: "Cancelar" },
  "qr.folder.create.creating": { en: "Creating...", es: "Creando..." },
  "qr.folder.create.create": { en: "Create Folder", es: "Crear Carpeta" },
  "qr.folder.create.success": { en: "Folder created successfully", es: "Carpeta creada exitosamente" },
  "qr.folder.create.error": { en: "Failed to create folder", es: "Error al crear carpeta" },
  
  // Delete Confirmations
  "qr.delete.confirm": { en: "Are you sure you want to delete this QR code?", es: "¿Estás seguro de que quieres eliminar este código QR?" },
  "qr.delete.success": { en: "QR code deleted successfully", es: "Código QR eliminado exitosamente" },
  "qr.delete.error": { en: "Failed to delete QR code", es: "Error al eliminar código QR" },
  "qr.folder.delete.confirm": { en: "Are you sure you want to delete this folder? QR codes inside will not be deleted.", es: "¿Estás seguro de que quieres eliminar esta carpeta? Los códigos QR dentro no se eliminarán." },
  "qr.folder.delete.success": { en: "Folder deleted successfully", es: "Carpeta eliminada exitosamente" },
  "qr.folder.delete.error": { en: "Failed to delete folder", es: "Error al eliminar carpeta" },
  
  // Navigation
  "nav.passwords": { en: "Passwords", es: "Contraseñas" },
  "nav.qrCodes": { en: "QR Codes", es: "Códigos QR" },
  "nav.barCodes": { en: "Bar Codes", es: "Códigos de Barras" },
};
