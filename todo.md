...
- [x] Error: Could not find build directory /dist/public
- [x] Actualizar script de build para compilar cliente primero
- [x] Asegurar que dist/public/index.html se genere correctamente
